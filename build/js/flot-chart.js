(function($) {
  ...
  function labelFormatter(label, series) {
    return "<div styles='font-size:8pt; text-align:center; padding:2px; color:white;'>" + label + "<br/>" + Math.round(series.percent) + "%</div>";
  }
  ...
  /*---------------------------------------------------
      Make some random data for Recent GameItems chart
  ---------------------------------------------------*/
