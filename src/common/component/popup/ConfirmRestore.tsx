...
@observer
class ConfirmRestore extends Component<IProps, any> {


    render() {
        return (
            <div className="modal fade" id="modal_confirm_restore" tabIndex={-1} role="dialog" aria-hidden="true">
                <div className="modal-dialog h-75 d-flex align-items-center justify-content-center" role="document">
                    <div className="modal-content">
                        <div className="modal-header pt-2 pb-2">
                            <button type="button" id="close_restore" className="close" data-dismiss="modal" aria-label="Close">
